...
// 반 평균 계산
export const getClassAverage = (req, res) => {
  try {
    ...
    const classAverage = Score.calculateClassAverage(classId, exam_date);
...
// 이전 성적과 비교
export const compareWithPrevious = (req, res) => {
  try {
    ...
    // 현재 성적 조회
    const currentScore = Score.getByStudentAndDate(studentId, exam_date);
    ...
    // 이전 성적 조회
    const previousScore = Score.getPreviousScore(studentId, exam_date);
